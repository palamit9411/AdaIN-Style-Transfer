...
def parse_arguments():
    ...
    parser.add_argument('--content_dir', type=str, default='D:\\NST_code\\content_data', help='Location of content dataset')

    parser.add_argument('--style_dir', type=str, default='D:\\NST_code\\style_data',   help='Location of style dataset')

    parser.add_argument('--vgg', type=str, default='D:\\NST_code\\vgg_normalised.pth',          help='Location of pre-trained VGG')
    ...
    parser.add_argument('--decoder_path', type=str, default=None, help='Location of decoder checkpoint')

    parser.add_argument('--optimizer_path', type=str, default=None, help='Location of optimizer checkpoint')
...
def main():
    ...
    content_dataloader = DataLoader(content_dataset, batch_size=args.batch_size, shuffle=True, pin_memory=True, num_workers=2, persistent_workers=True, drop_last=True)

    style_dataloader = DataLoader(style_dataset, batch_size=args.batch_size, shuffle=True, pin_memory=True, num_workers=2, persistent_workers=True, drop_last=True)
